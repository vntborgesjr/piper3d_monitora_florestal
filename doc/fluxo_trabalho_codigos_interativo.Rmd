...
# carregar dados_completos.R da pasta doc
dados_completos <- readr::read_rds(
  corrigir_diretorio(
    corrige = "data/dados_completos.rds"
  )
) 


# carregar dados_filtrados.R da pasta data para o R
dados_filtrados <- readr::read_rds(
  corrigir_diretorio(
...
tidyr::separate_wider_delim(
  ...
  relocate(
    uc_category,
    .before = `Local - Nome da Unidade de Conservação`
  ) |> 
  relocate(
    uc_name_abv,
    .after = `Local - Nome da Unidade de Conservação`
  )
