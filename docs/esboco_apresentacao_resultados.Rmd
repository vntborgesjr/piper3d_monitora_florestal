...
corte_cutias \<- create_bins(cutia_tap_arap[!is.na(cutia_tap_arap\$distance),], c(0,1,8,14, 22, 30, 40, 50))\

hist(corte_cutias\$distance, breaks = c(0,1,8,14, 22, 30, 40, 50))
