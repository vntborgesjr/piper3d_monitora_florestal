...
area_esforco_hr <- cutia_tap_arap_hr$`Sem termo` |> 
...
Sugestão de organização dessa parte: independente do método, tem qiue bolar uma forma de automatizar a forma de obter o nome dos modelos e gera a coluna com seus nomes. Se achar que ficou melhor assim, transformo em função e reproduzo pro demais resultados.

###### Caracteristicas da área e esforço

```{r}
# área de estudo, tamanho da área de estudo, area coberta pelo esforço amostral, esforço amostral em metros, número de detecções, número de transectos (ea), taxa de encontro, coeficiente de variação da taxa de encontro  
area_esforco_hr_sem_termo <- cutia_tap_arap_hr$`Sem termo` |> 
  gerar_caracteristicas_area_estudo_taxa_encontro()

area_esforco_hr_cosseno <- cutia_tap_arap_hn$Cosseno |> 
  gerar_caracteristicas_area_estudo_taxa_encontro()

area_esforco_unif_cosseno <- cutia_tap_arap_unif$Cosseno |> 
  gerar_caracteristicas_area_estudo_taxa_encontro()

area_esforco_unif_polinomial <- cutia_tap_arap_unif$`Polinomial simples` |> 
  gerar_caracteristicas_area_estudo_taxa_encontro()

area_esforco_hn_sem_termo <- cutia_tap_arap_hn$`Sem termo` |> 
  gerar_caracteristicas_area_estudo_taxa_encontro()

# é importante que a ordem de entrada dos objetos respeitem a ordema da tabela de selecao de modelos
