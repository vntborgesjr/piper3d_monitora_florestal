...
cutia_tap_arap_quase_sem_repeticao_unif_scov <- cutia_tap_arap_quase_sem_repeticao |> 
  ajustar_modelos_Distance(
    funcao_chave = "unif",
    truncamento = "10%"
    )
...
###### Half-normal sem covariáveis (HN)
...
cov_lista_modelos_ajustados <- list(
  `Uniform`= cutia_tap_arap_quase_sem_repeticao_unif_scov,
  `half-normal` = c(cutia_tap_arap_quase_sem_repeticao_hn_scov, cutia_tap_arap_quase_sem_repeticao_hn_size), 
  `hazard-rate` = c(cutia_tap_arap_quase_sem_repeticao_hr_scov, cutia_tap_arap_quase_sem_repeticao_hr_size)
)
...
```{r}
# carregar dados
cutia <- transforma_para_distanceR_com_repeticao_filtra_uc_sp(
  nome_uc = "Resex Tapajos-Arapiuns",
  nome_sp = "Dasyprocta croconota"
) 
