...
```{r}
dasy_croc_serra_pardo <- transformar_para_distanceR_covariaveis_sem_repeticao() |>   filter(
    Region.Label == "Parna da Serra do Pardo", 
    sp_name == "Dasyprocta croconota"
  ) |> 
  drop_na(distance)
...
dasy_croc_serra_pardo_quase_sem_repeticao <- dasy_croc_serra_pardo |> 
...
dasy_croc_terra_meio_quase_sem_repeticao <- dasy_croc_terra_meio |> 
  filter(sampling_day %in% filtro_datas_quase_sem_repeticao,
         Region.Label == "Esec da Terra do Meio")
