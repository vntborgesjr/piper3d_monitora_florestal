...
##### Ajustando modelos para cada estrato
...
```{r}
# ajustando a função de detecção half-normal para um truncamento de 10% dos dados
cutias_distance_hn_cos <- cutias_distance |> 
  ajustar_modelos_Distance(
    funcao_chave = "hn",
    termos_ajuste = 
    truncamento = "10%")
