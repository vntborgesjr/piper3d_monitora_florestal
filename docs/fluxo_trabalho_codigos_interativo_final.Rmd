...
1library(distanceMonitoraflorestal)
...
Observar que nesse caso o tamanho do grupo conferiu uma leve melhora ao ajuste dos modelos.
...
```{r}
selecao_funcao_deteccao_termo_ajuste_cutias <- selecionar_funcao_deteccao_termo_ajuste(
...
selecao_funcao_deteccao_termo_ajuste_cutias
...
modelos_cutias <- gerar_lista_modelos_selecionados(
  ...
  cutias_distance_unif$`Polinomial simples`,
  cutias_distance_hn$`Sem termo`,
  nome_modelos_selecionados = selecao_funcao_deteccao_termo_ajuste_cutias
)
