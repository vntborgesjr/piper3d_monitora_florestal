...
#' @examples \dontrun{gerar_dados_completos_SMART(dados = dados_brutos)}
gerar_dados_completos_SMART <- function(dados) {
  ...
  nomes_novos_pt <- c(
    ...
    data_amostragem = nomes_antigos[6], # considerada coluna data de início de
    # amostragem
    ano = nomes_antigos[8],
    estacao = nomes_antigos[9],
    esforco_dia = nomes_antigos[5],
    nomes_antigos[21],
    nomes_antigos[22],
    nomes_antigos[23],
    nomes_antigos[24],
    nome_sp = nomes_antigos[25],
    validacao = nomes_antigos[27],
    distancia = nomes_antigos[30],
    tamanho_grupo = nomes_antigos[28],
    observadores = nomes_antigos[17],
    horario_inicio = nomes_antigos[10],
    horario_termino = nomes_antigos[11],
    velocidade_km_h = nomes_antigos[13]
  )
